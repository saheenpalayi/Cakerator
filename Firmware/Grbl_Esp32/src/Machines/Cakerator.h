...
#define MACHINE_NAME "Cakerator"

// This causes the custom code file to be included in the build
// via ../custom_code.cpp
#define CUSTOM_CODE_FILENAME "Custom/Cakerator.cpp"
...
#define DEFAULT_Y_STEPS_PER_MM 142.220
#define DEFAULT_Z_STEPS_PER_MM 3.0 // This is percent in servo mode
...
#define DEFAULT_Z_MAX_TRAVEL 5000.0 // This is percent in servo mode
